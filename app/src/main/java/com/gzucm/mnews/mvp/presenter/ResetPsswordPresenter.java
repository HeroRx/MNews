...
@ActivityScope
public class ResetPsswordPresenter extends BasePresenter<ResetPsswordContract.Model, ResetPsswordContract.View> {
    @Inject
    ...
    @Inject
    public ResetPsswordPresenter(ResetPsswordContract.Model model, ResetPsswordContract.View rootView) {
    ...
    public void resetPasswordByEmailed(User user){
        mModel.resetPasswordByEmailed(user)
